...
class AlienFleet:
    ...
    def create_fleet(self):
        ...
        x_offset, y_offset = self.calculate_offsets(alien_w, alien_h, screen_h, fleet_w, fleet_h)
        self._create_rectangle_fleet(alien_w, alien_h, fleet_w, fleet_h, x_offset, y_offset)

    def _create_rectangle_fleet(self, alien_w:int, alien_h:int, fleet_w:int, fleet_h:int, x_offset:int, y_offset:int):
        """
    ...
    def calculate_offsets(self, alien_w:int, alien_h:int, screen_h:int, fleet_w:int, fleet_h:int):
        ...
        #y_offset = 0#int((half_screen - fleet_vertical_space) // 2)
