...
class HUD:
    ...
    def _setup_life_image(self):
        """load the sprites representing player lives
        """
    ...
    def _update_score(self):
        """re-render and position the current score
        """
    ...
    def _update_max_score(self):
        """re-render and position the max score"""
    ...
    def _update_hi_score(self):
        """re-render and position the hi-score"""
    ...
    def update_level(self):
        """re-render and position the level counter
        """
    ...
    def _draw_lives(self):
        """draw the sprites representing player lives
        """
    ...
    def draw(self):
        """put all the scores, level and lives on a screen
        """
